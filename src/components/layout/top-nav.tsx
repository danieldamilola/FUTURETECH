...
export function TopNav() {
  ...
  return (
    <header className="h-[56px] border-b border-[var(--border)] bg-[var(--bg)] sticky top-0 z-50 px-4 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2.5">
        {isLoggedIn ? (
          ...
          <Link
            href="/login"
            className="px-3 py-1.5 text-xs text-[var(--ink)] hover:bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-sm)] transition-colors flex items-center gap-1.5"
          >
