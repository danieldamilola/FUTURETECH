          ...
          {!showEmailForm ? (
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-[var(--surface-high)] hover:bg-[var(--surface-hover)] border border-[var(--border-strong)] text-[var(--ink)] text-xs font-semibold rounded-[var(--radius-sm)] flex items-center justify-center gap-2.5 transition-colors cursor-pointer"
              >
